...
got_highest_raise <- salaries[salaries$change == highest, "employees"]

# What was the largest decrease in salaries between the two years?

biggest_decrease <- min(salaries$change)

# What was the name of the employee who recieved largest decrease in salary?

got_biggest_decrease <- salaries[salaries$change == biggest_decrease, "employees"]
...
avg_decrease <- mean(salaries$change[salaries$got_raise == FALSE])
